package id.slametriyadi.ojekbeneran.helper;
...
public class MyContants {
    public static final String BASE_URL = "http://192.168.20.224/db_ojekkece/api/";
    ...
    public static final String IDBOOKING = "idbooking";
